...
## Production Twilio Video setup

This project now uses Twilio Programmable Video for live debate sessions. Access tokens are minted by the Supabase Edge Function `twilio-video-token`.
